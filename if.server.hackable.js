...
export default class HackableBaseServer extends BaseServer {
  ...
  get isTarget() { return (!this.purchased && !this.isHome && (this.money.max > 0) && (this.ports.open >= this.ports.required) && this.admin && (this.level <= this.ns.getPlayer().skills.hacking)) }
